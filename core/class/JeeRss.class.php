    ...
    */
    ...
    public function toHtml($_version = 'dashboard') {
        ...
        if(file_exists($cache_Rss)) {
            ...
            $direction       = JeeRss::getConfiguration('sens');
            $speed           = JeeRss::getConfiguration('vitesse');
            ...
            elseif ($direction == "up" or $direction == "down") {
            ...
            $ligne = "";
            if (($nbFeed == 1) || (count($rss) < 2)) {
                $espacement = "";
            }

            foreach (array_slice($rss, 0, $nbFeed) as $tab) {
                if ($date == 1) {
